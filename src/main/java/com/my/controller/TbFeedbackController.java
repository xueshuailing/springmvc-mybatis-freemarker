...
import com.my.service.TbFeedbackService;
import com.my.entity.TbFeedback;
/**
 * controller层
 */
@Controller
@RequestMapping(value = "/my/tbfeedback")
public class TbFeedbackController extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TbFeedbackController.class);
	@Resource
	...
	*/
	...
	public String  save(Model model,TbFeedback t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFeedbackService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbFeedback t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFeedbackService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  deleteById(Model model,@RequestParam(value="id", required=true, defaultValue="0") String id,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFeedbackService.deleteById(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbFeedback t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFeedbackService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbFeedback t=new TbFeedback();
		try {
			  t= this.tbFeedbackService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbFeedback t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbFeedbackService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
