...
import com.my.service.TbVersionService;
import com.my.entity.TbVersion;
/**
 * 版本控制表controller层
 */
@Controller
@RequestMapping(value = "/my/tbversion")
public class TbVersionController extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TbVersionController.class);
	@Resource
	...
	*/
	...
	public String  save(Model model,TbVersion t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbVersionService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbVersion t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbVersionService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  deleteById(Model model,@RequestParam(value="id", required=true, defaultValue="0") String id,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbVersionService.deleteById(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbVersion t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbVersionService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbVersion t=new TbVersion();
		try {
			  t= this.tbVersionService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbVersion t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbVersionService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
