...
import com.my.service.TbFamilyService;
import com.my.entity.TbFamily;
/**
 * 家庭成员表controller层
 */
@Controller
@RequestMapping(value = "/my/tbfamily")
public class TbFamilyController extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TbFamilyController.class);
	@Resource
	...
	*/
	...
	public String  save(Model model,TbFamily t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFamilyService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbFamily t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFamilyService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  deleteById(Model model,@RequestParam(value="id", required=true, defaultValue="0") String id,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFamilyService.deleteById(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbFamily t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbFamilyService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbFamily t=new TbFamily();
		try {
			  t= this.tbFamilyService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbFamily t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbFamilyService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
