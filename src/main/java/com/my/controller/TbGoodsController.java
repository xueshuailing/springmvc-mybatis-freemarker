...
import com.my.service.TbGoodsService;
import com.my.entity.TbGoods;
/**
 * controller层
 */
@Controller
@RequestMapping(value = "/my/tbgoods")
public class TbGoodsController extends BaseController {
	private static final Logger logger = LoggerFactory.getLogger(TbGoodsController.class);
	@Resource
	...
	*/
	...
	public String  save(Model model,TbGoods t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbGoodsService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbGoods t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbGoodsService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  deleteById(Model model,@RequestParam(value="id", required=true, defaultValue="0") String id,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbGoodsService.deleteById(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbGoods t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbGoodsService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbGoods t=new TbGoods();
		try {
			  t= this.tbGoodsService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbGoods t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbGoodsService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
