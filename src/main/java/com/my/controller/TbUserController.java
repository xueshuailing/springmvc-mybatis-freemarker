...
public class TbUserController extends BaseController {
	...
	*/
	...
	public String  save(Model model,TbUser t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbUserService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbUser t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbUserService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbUser t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbUserService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbUser t=new TbUser();
		try {
			  t= this.tbUserService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbUser t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbUserService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
