...
import com.my.service.OrderCommentService;
import com.my.entity.OrderComment;
/**
 * controller层
 */
@Controller
@RequestMapping(value = "/my/ordercomment")
public class OrderCommentController extends BaseController {
	...
	*/
	...
	public String  save(Model model,OrderComment t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.orderCommentService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,OrderComment t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.orderCommentService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,OrderComment t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.orderCommentService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	OrderComment t=new OrderComment();
		try {
			  t= this.orderCommentService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,OrderComment t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.orderCommentService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
