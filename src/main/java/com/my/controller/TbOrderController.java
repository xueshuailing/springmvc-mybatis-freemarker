...
import com.my.service.TbOrderService;
import com.my.entity.TbOrder;
/**
 * controller层
 */
@Controller
@RequestMapping(value = "/my/tborder")
public class TbOrderController extends BaseController {
	...
	*/
	...
	public String  save(Model model,TbOrder t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbOrderService.save(t);
		} catch (Exception e) {
	...
	*/
	...
	public String  deleteByParameter(Model model,TbOrder t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbOrderService.deleteByParameter(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  deleteById(Model model,@RequestParam(value="id", required=true, defaultValue="0") String id,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbOrderService.deleteById(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  update(Model model,TbOrder t,HttpServletRequest request,HttpServletResponse response){
		try {
			 this.tbOrderService.update(t);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	TbOrder t=new TbOrder();
		try {
			  t= this.tbOrderService.detail(id);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	*/
	...
	public String  query(Model model,TbOrder t,@RequestParam(value="pageNo", required=true, defaultValue="1")  int pageNo,@RequestParam(value="pageSize", required=true, defaultValue="10") int pageSize,HttpServletRequest request,HttpServletResponse response){
		Map<String,Object> map=new HashMap<String,Object>();
		try {
				map= this.tbOrderService.query(t,pageNo,pageSize);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
