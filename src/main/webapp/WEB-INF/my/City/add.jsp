  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      		<form class="form-horizontal"    method="post" id="save" action="<%=basePath%>my/city/save.html">
			...
			<div class="form-group" >
				<label for="cityNamediv" class="col-sm-2 control-label" >
					<strong>：</strong>
				</label>
				<div class="input-group col-sm-6" id="cityNamediv">
					<input type="text" class="form-control" id="cityName" name="cityName" placeholder=""     required   onkeydown="if(event.keyCode==32) return false"    >
				</div> 
			</div>
			<div class="form-group" >
			...
			<div class="form-group" >
				<label for="citySortdiv" class="col-sm-2 control-label" >
					<strong>：</strong>
				</label>
				<div class="input-group col-sm-6" id="citySortdiv">
					<input type="text" class="form-control" id="citySort" name="citySort" placeholder=""     required   onkeydown="if(event.keyCode==32) return false"    >
				</div> 
			</div>
			</form>
      </div>
