...
<html  lang="zh-CN">
  ...
  <body>
  <form class="form-horizontal" role="form" id="serch" method="post" action="<%=basePath%>my/tbmarketclassify/query.html">
...
<!-- 添加弹出窗口 -->
<jsp:include  page="/WEB-INF/my/TbMarketClassify/add.jsp" flush="true"/> 
		<!-- 日期插件js -->
...
$(function () {
  ...
  $('[data-toggle="tooltip"]').tooltip();
        ...
        visiblePages: 7,
         href: '<%=basePath%>my/tbmarketclassify/query.html?pageNo={{number}}',
